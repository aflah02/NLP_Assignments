...
df = pd.read_csv('Neemesh_A2/A1_dataset.csv')
...
df = pd.read_csv('Neemesh_A2/preprocessed_A1.csv')
preprocess_text = df['preprocessed_text'].to_list()
...
with open('Neemesh_A2\Pos Neg Prompts\ls_word_sentiment_vader.pickle', 'wb') as f:
...
with open('Neemesh_A2\Pos Neg Prompts\ls_word_sentiment_hf.pickle', 'wb') as f:
