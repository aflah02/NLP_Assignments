...
def txtTocsv(negFilePath, posFilePath):
    ...
    df.to_csv(f"Neemesh_A2/generatedCSVs/generated_{filename}.csv")

txtTocsv("Neemesh_A2\\generated_sentences\\neg_gen_add_numerator.txt", "Neemesh_A2\\generated_sentences\\pos_gen_add_numerator.txt")
txtTocsv("Neemesh_A2\\generated_sentences\\neg_gen_div_denominator.txt", "Neemesh_A2\\generated_sentences\\pos_gen_div_denominator.txt")
txtTocsv("Neemesh_A2\\generated_sentences\\neg_gen_mul_numerator.txt", "Neemesh_A2\\generated_sentences\\pos_gen_mul_numerator.txt")
txtTocsv("Neemesh_A2\\generated_sentences\\neg_gen_only_ext.txt", "Neemesh_A2\\generated_sentences\\pos_gen_only_ext.txt")
txtTocsv("Neemesh_A2\\generated_sentences\\neg_hf_prompts.txt", "Neemesh_A2\\generated_sentences\\pos_hf_prompts.txt")
txtTocsv("Neemesh_A2\\generated_sentences\\neg_ppl_normalized.txt", "Neemesh_A2\\generated_sentences\\pos_ppl_normalized.txt")
txtTocsv("Neemesh_A2\\generated_sentences\\neg_vader_textblob.txt", "Neemesh_A2\\generated_sentences\\pos_vader_textblob.txt")